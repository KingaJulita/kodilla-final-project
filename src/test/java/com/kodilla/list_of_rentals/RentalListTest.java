package com.kodilla.list_of_rentals;
...
public class RentalListTest {
    ...
    @Test
    public void testNavigateToRentals() throws InterruptedException {
        ...
        WebElement rentHistoryHeader = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h2[contains(text(), 'Rents history')]")));
        assertTrue(rentHistoryHeader.isDisplayed(), "Rent history page is not displayed.");
