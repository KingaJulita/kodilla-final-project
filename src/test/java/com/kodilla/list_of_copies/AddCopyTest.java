...
public class AddCopyTest {
    private WebDriver driver;

    @Test
    public void testAddCopy() throws InterruptedException {
        ...
        WebElement addNewButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("add-item-button")));
